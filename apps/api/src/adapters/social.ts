...
export const twitchAdapter = createSocialAdapter('twitch')
...
export const blueskyAdapter = createSocialAdapter('bluesky')
export const mastodonAdapter = createSocialAdapter('mastodon')
export const linkedinAdapter = createSocialAdapter('linkedin')
export const telegramAdapter = createSocialAdapter('telegram')
export const pinterestAdapter = createSocialAdapter('pinterest')
export const snapchatAdapter = createSocialAdapter('snapchat')
export const tumblrAdapter = createSocialAdapter('tumblr')